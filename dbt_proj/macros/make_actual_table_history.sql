{# Бокоч. Макрос формирует исторические данные #}
...
{%- macro make_actual_table_history ( p_source_name, p_source_table_name, p_id_column_name, p_date_distinct_column_name ) -%}
  select *
  from 
    (
    select
